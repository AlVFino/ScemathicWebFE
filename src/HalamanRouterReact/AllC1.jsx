            ...
            <div className="col-span-9">
                <div className="grid max-w-md grid-cols-1 mx-auto lg:max-w-full  lg:grid-cols-3 gap-x-16 gap-y-12">
                    ...
                    <div className="bg-gray-50 rounded shadow p-3">
                        ...
                        <span className="block text-sm font-bold tracking-widest text-gray-500 uppercase mt-5"> Gratis </span>
                    </div>
                    ...
                    <div className="bg-white rounded shadow p-3">
                        ...
                        <p className="mt-6 text-xl font-semibold">
                            <a href="#" title="" className="text-black"> emails you want to use on next campaign. </a>
                        </p>
                        <span className="block text-sm font-bold tracking-widest text-gray-500 uppercase mt-3"> Gratis </span>
                    </div>
