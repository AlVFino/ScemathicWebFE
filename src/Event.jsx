        ...
        <section id="Event" >
            <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                ...
                <div className="flex-1 text-center lg:text-left">
                        <p className="text-lg font-bold leading-tight text-indigo-600 mt-6 sm:text-xl lg:text-2xl">Event</p>
                        <h2 className="text-2xl mx-auto mt-1  font-bold leading-relaxed  lg:mx-0 lg:text-5xl sm:text-4xl">Ikuti Event Yang Akan Datang Yukk!!</h2>
                        <h5 className="text-xl mx-auto mt-3  leading-relaxed  lg:mx-0 lg:text-3xl sm:text-2xl">Cari Event Sesuai Keinginanmu</h5>
                    </div>
