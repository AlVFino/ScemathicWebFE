...
const DashboardUser = () => {
  ...
  return (
    ...
    <div id="dbuser" className="mt-16 px-6 py-6 flex flex-col md:flex-row min-h-screen bg-gray-50">
      {/* Sidebar */}
      ...
      <main id="content" className="flex-1 bg-white border border-gray-300 rounded-lg shadow-md p-8 md:ml-6 mt-10 md:mt-0">
        ...
        <section id="infoCourse" className="grid md:grid-cols-3 gap-6">
            ...
            <div className="p-6 bg-gray-100 rounded-lg text-center font-medium shadow-sm flex flex-col items-center">
                <BookOpenIcon className="w-8 h-8 text-green-500 mb-2" />
            ...
            <div className="p-6 bg-gray-100 rounded-lg text-center font-medium shadow-sm flex flex-col items-center">
                <CalendarIcon className="w-8 h-8 text-red-500 mb-2" />
                Event Diikuti
            </div>
            <div className="p-6 bg-gray-100 rounded-lg text-center font-medium shadow-sm flex flex-col items-center">
            ...
            <div className="p-6 bg-gray-100 rounded-lg text-center font-medium shadow-sm flex flex-col items-center">
                <CalendarIcon className="w-8 h-8 text-yellow-500 mb-2" />
                Event Selesai
            </div>
        </section>
        {/* Course */}
