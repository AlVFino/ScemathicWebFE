...
const CourseUser = () => {
  ...
  return (
    ...
    <div id="courseUser" className="mt-16 px-6 py-6 flex flex-col md:flex-row min-h-screen bg-gray-50">
      {/* Sidebar */}
      <aside id="sideBar" className="bg-white border border-gray-300 rounded-lg shadow-md lg:w-48 md:w-48 sm:w-24 h-[40vh] p-5 flex flex-col flex-shrink-0 xl:w-64">
        ...
        <Link to="/dasboard_user">
          ...
          <Link to="/course_user">
            <p className=" font-semibold text-gray-600 cursor-pointer hover:text-gray-800 flex items-center gap-2 mb-2">
