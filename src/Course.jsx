      ...
      <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="flex items-end justify-between">
          <div className="flex-1 text-center lg:text-left">
            <p className="text-lg font-bold leading-tight text-indigo-600 mt-6 sm:text-xl lg:text-2xl">
              Course
            </p>
            <h2 className="text-2xl mx-auto mt-1  font-bold leading-relaxed  lg:mx-0 lg:text-5xl sm:text-4xl">
              Mau Balajar Apa Hari Ini?
            </h2>
            <h5 className="text-xl mx-auto mt-3  leading-relaxed  lg:mx-0 lg:text-3xl sm:text-2xl">
              Cari Course Sesuai Keinginanmu
            </h5>
          </div>
        </div>
          ...
          <div className="grid max-w-md grid-cols-1 gap-6 mx-auto mt-3 lg:mt-5 lg:grid-cols-3 lg:max-w-full ">
              ...
              <div className="overflow-hidden bg-white rounded shadow cursor-pointer hover:shadow-xl">
                <div className="p-5">
                  ...
                  <div className="flex flex-col  items-start">
                    <span className="inline-flex px-4 py-2 mt-3 text-xs font-semibold tracking-widest uppercase rounded-full text-white bg-blue-500 mt-9">
                      {" "}
                      Programming{" "}
                    </span>
            ...
            <div className="overflow-hidden bg-white rounded shadow cursor-pointer hover:shadow-xl">
              <div className="p-5">
                ...
                <div className="flex flex-col  items-start">
                  <span className="inline-flex px-4 py-2 mt-3 text-xs font-semibold tracking-widest uppercase rounded-full text-white bg-orange-500 mt-9">
                    {" "}
                    Desain UI/UX{" "}
                  </span>
                  <span className="inline-flex items-start pb-0.5 ms-1 mt-1 text-base font-semibold text-dark-600 transition-all duration-200 border-b-2 border-transparent hover:border-blue-600 focus:border-blue-600">
                ...
                <p className="mt-5 text-2xl font-semibold">
                  <a href="#" title="" className="text-black">
                    Tutorial FIGMA Dasar Untuk Pemula!{" "}
                  </a>
                </p>
                <p className="mt-4 text-base text-gray-600">
            ...
            <div className="overflow-hidden bg-white rounded shadow cursor-pointer hover:shadow-xl">
              <div className="p-5">
                ...
                <div className="flex flex-col  items-start">
                  <span className="inline-flex px-4 py-2 mt-3 text-xs font-semibold tracking-widest uppercase rounded-full text-white bg-green-500 mt-9">
                    {" "}
                    Framework{" "}
                  </span>
                  <span className="inline-flex items-start pb-0.5 ms-1 mt-1 text-base font-semibold text-dark-600 transition-all duration-200 border-b-2 border-transparent hover:border-blue-600 focus:border-blue-600">
                ...
                <p className="mt-5 text-2xl font-semibold">
                  <a href="#" title="" className="text-black">
                    Tutorial Bootstrap Dasar Untuk Pemula!{" "}
                  </a>
                </p>
                <p className="mt-4 text-base text-gray-600">
                  Amet minim mollit non deserunt ullamco est sit aliqua dolor do
