...
const Profil_admin = () => {
  ...
  return (
    <div id="admin" className="mt-16 px-6 py-6 flex ">
    {/* Sidebar */}
    <aside id="sideBar" className="bg-white border border-gray-300 rounded-lg shadow-md lg:w-48 md:w-48 sm:w-24 h-[50vh] p-5 flex flex-col flex-shrink-0 xl:w-64">
      ...
      <Link to="/dasboard_admin">
          ...
          <Link to="/profil_admin">
            <p className="font-semibold text-gray-600 cursor-pointer hover:text-gray-800 flex items-center gap-2">
    ...
    <main id="content" className="flex-1 bg-white border border-gray-300 rounded-lg shadow-md p-8 ml-6">
        ...
        {activeTab === "profile" && (
          <section id="profile">
            <div className="p-6 rounded-lg flex flex-col lg:flex-row gap-8">
              ...
              <div className="flex flex-col items-center justify-center bg-white p-5 rounded-lg shadow-md border border-gray-300 w-full lg:w-1/3">
                <img src="#" alt="Foto Profil" className="w-64 h-64 rounded-full border border-gray-300 shadow-md" />
