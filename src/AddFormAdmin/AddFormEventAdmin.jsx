...
const AddFormEventAdmin = () => {
  ...
  return (
                ...
                <main id="content" className="flex-1 bg-white border border-gray-300 rounded-lg shadow-md p-8 ml-6">
                    <a href="/event_admin"><ArrowLeftIcon className="w-5 h-5 mb-5" /></a>
                  {/* Add Cpurse */}
                    <div className="Add-Course ms-5">
                        <h2 className="text-3xl font-bold mb-4">Tambah Event</h2>
                        ...
                        <div className="">   
                            <form className="grid md:grid-cols-2 gap-4">
                                ...
                                <div className="flex flex-col">
                                    <label htmlFor="" className="mb-2">Link Group WhatsApp:</label>
                                    <input type="text" name="Vidio_Link" placeholder="Link Group WA" className="border p-2 rounded" required/>
                                </div>
                                <div className="flex flex-col">
                                ...
                                <div className="flex flex-col">
                                    <label htmlFor="" className="mb-2">Location meet :</label>
                                    <input type="text" name="location" placeholder="location meet" className="border p-2 rounded" required />
                                </div>
                                <div className="flex flex-col">
