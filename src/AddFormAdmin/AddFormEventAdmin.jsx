import {
    ...
    return (
      <div className="mt-16 px-4 py-6 flex flex-col lg:flex-row min-h-screen bg-gray-50 gap-4">
        ...
        <main className="flex-1 bg-white border border-gray-300 rounded-lg shadow-md p-6">
          <Link to="/event_admin" className="inline-block mb-4 text-gray-700 hover:text-blue-600 transition">
            <ArrowLeftIcon className="w-5 h-5" />
          </Link>
  
          <div className="mx-auto w-full max-w-3xl">
            <h2 className="text-2xl md:text-3xl font-bold mb-6">Tambah Event</h2>
            ...
            <form className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="flex flex-col">
                <label className="mb-2">Link Group WhatsApp:</label>
                <input
                  type="text"
                  name="Vidio_Link"
                  placeholder="Link Group WA"
                  className="border p-2 rounded"
                  required
                />
              </div>
              <div className="flex flex-col">
                <label className="mb-2">Penulis:</label>
                <input
                  type="text"
                  name="author"
                  placeholder="Penulis"
              ...
              <div className="flex flex-col">
                <label className="mb-2">Location meet:</label>
                <input
                  type="text"
                  name="location"
                  placeholder="Lokasi Meet"
                  className="border p-2 rounded"
                  required
                />
              </div>
              ...
              <button
                type="submit"
                className="md:col-span-2 bg-blue-500 text-white p-2 rounded hover:bg-blue-600 transition"
              >
                Tambah Event
              </button>
            </form>
  ...
  export default AddFormEventAdmin;
